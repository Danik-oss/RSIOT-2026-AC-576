...
- `web23_http_requests_total` - Counter запросов
- `web23_http_request_duration_seconds` - Histogram задержки

## Алерты

1. **LowAvailability** - доступность < 99.6%
2. **HighErrorRate5xx** - 5xx ошибок > 1% за 5м
3. **HighLatencyP95** - p95 latency > 220ms
