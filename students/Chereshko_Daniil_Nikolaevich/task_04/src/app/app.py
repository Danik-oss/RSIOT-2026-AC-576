...
Вариант 23: prefix=web23_, SLO=99.6%, p95≤220ms, Alert: 5xx>1% за 5м
"""
...
METRICS_PREFIX = "web23_"

# Метрики с префиксом web23_
...
# Метаданные студента
STUDENT_ID = os.getenv('STUDENT_ID', '220250')
STUDENT_GROUP = os.getenv('STUDENT_GROUP', 'АС-576')
